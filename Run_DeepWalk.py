...
from modular_methods.embedding_utils import get_graph_embeddings_DeepWalk
...
graph_embeddings = get_graph_embeddings_DeepWalk(combined_graph, dimensions=384)
...
for alpha in alpha_values:
    ...
    output_path = f"matches_LLM/HybridDeepWalk_alpha_{alpha}.json"
...
with open("runtimes.txt", "a") as f:
    f.write(f"Run with model = DeepWalk and alpha={alpha_values} took {runtime:.2f} seconds\n")